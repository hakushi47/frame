...
const RESULT_IMAGE_RESIZE_MODE: 'cover' | 'contain' = 'cover';

export default function TemplateResult2Screen() {
    ...
    <SafeAreaView style={styles.safeArea} edges={['top', 'bottom']}>
      ...
      <View style={styles.content}>
        {isGenerating ? (
          ...
          <Image source={{ uri: outlineDataUrl }} style={styles.resultImage} resizeMode={RESULT_IMAGE_RESIZE_MODE} />
        ) : (
          <View style={styles.centerContent}>
